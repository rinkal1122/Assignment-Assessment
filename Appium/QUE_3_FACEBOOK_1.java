		...
		driver.manage().timeouts().implicitlyWait(30,TimeUnit.SECONDS);
		 ...
		 driver.findElement(By.id("com.android.permissioncontroller:id/permission_allow_button")).click();
			...
			driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/"
					...
					+ "android.view.ViewGroup[2]/android.widget.MultiAutoCompleteTextView[1]")).sendKeys("tiri@gmail.com");
			Thread.sleep(1000);
			driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/"
					+ "android.widget.LinearLayout/android.widget.FrameLayout/"
					+ "android.widget.FrameLayout/android.widget.FrameLayout[2]/"
					+ "android.view.ViewGroup[2]/android.widget.MultiAutoCompleteTextView[2]")).sendKeys("tiku@123");
			Thread.sleep(1000);
			driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/"
					+ "android.widget.LinearLayout/android.widget.FrameLayout/"
					+ "android.widget.FrameLayout/android.widget.FrameLayout[2]/"
