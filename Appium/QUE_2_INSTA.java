...
public class QUE_2_INSTA {
	@Test
public void loginpass() throws InterruptedException, MalformedURLException {
...
driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/"
	...
	+ "android.view.ViewGroup[3]/android.view.ViewGroup[3]/android.view.View")).click();
			...
			driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/"
					+ "android.widget.LinearLayout/android.widget.FrameLayout/"
					+ "android.widget.FrameLayout/android.widget.FrameLayout/"
+ "android.view.ViewGroup[3]/android.widget.MultiAutoCompleteTextView[1]")).sendKeys("tiku_123");
			Thread.sleep(1000);
			driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/"
					+ "android.widget.LinearLayout/android.widget.FrameLayout/"
					+ "android.widget.FrameLayout/android.widget.FrameLayout/"
+ "android.view.ViewGroup[3]/android.widget.MultiAutoCompleteTextView[2]")).sendKeys("tiku@1234");
			Thread.sleep(1000);
			driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/"
					+ "android.widget.LinearLayout/android.widget.FrameLayout/"
					+ "android.widget.FrameLayout/android.widget.FrameLayout/"
